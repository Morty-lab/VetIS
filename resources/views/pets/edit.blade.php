                ...
                <div class="card-body">
                    <form action="{{ route('pets.update', ['petID' => $pet->id]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="inputPetName" type="text" placeholder="Enter Pet Name"
                                value="{{ $pet->pet_name }}" name="pet_name" autocomplete="off"/>
                        </div>
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                <label class="small mb-1" for="selectPetType">Pet Type <span class="text-danger">*</span></label>
                                <select class="edit-select-pet-type form-control" id="selectPetType" name="pet_type" data-placeholder="Select Pet Type">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputBreed" type="text" placeholder="Breed"
                                    value="{{ $pet->pet_breed }}" name="pet_breed" autocomplete="off"/>
                            </div>
                        </div>
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                        ...
                        <div class="row gx-3 gy-3 mb-3">
                            <div class="col-md-12">
                                ...
                                <select class="edit-select-pet-vaccination-record form-control" id="inputSelectVaccinationRecord" name="vaccinated" data-placeholder="No Vaccination Record/Complete/Incomplete">
                                    <option value=""></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex flex-col mt-2">
                                    <div class="form-check form-check-solid me-4">
                                        <input class="form-check-input" id="petNeuteredRadio1" type="radio" name="pet_neutered" value="1" {{$pet->neutered == 1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="petNeuteredRadio1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-solid">
                                        <input class="form-check-input" id="petNeuteredRadio2" type="radio" name="pet_neutered" value="0" {{$pet->neutered == 0 ? 'checked' : ''}}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex flex-col mt-2">
                                    <div class="form-check form-check-solid me-4">
                                        <input class="form-check-input" id="vaccinatedWithAR1" type="radio" name="vaccinated_anti_rabies" value="1"  {{$pet->vaccinated_anti_rabies == 1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="vaccinatedWithAR1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-solid">
                                        <input class="form-check-input" id="vaccinatedWithAR2" type="radio" name="vaccinated_anti_rabies" value="0" {{$pet->vaccinated_anti_rabies == 0 ? 'checked' : ''}}>
...
{{--                            </div>--}}
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-joined">
                                    <input type="month" id="inputAntiRabiesDate" name="anti_rabies_vaccination_date" class="form-control" value="{{\Carbon\Carbon::parse($pet->anti_rabies_vaccination_date)->format('Y-m')}}" placeholder="Select a Date">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-joined">
                                    <input type="month" name="last_groom_date" id="inputLastGroom" class="form-control" value="{{\Carbon\Carbon::parse($pet->last_groom_date)->format('Y-m')}}" placeholder="Select a Date">
                                    <span class="input-group-text">
                                        <i data-feather="calendar"></i>
                                    </span>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex flex-col mt-2">
                                    <div class="form-check form-check-solid me-4">
                                        <input class="form-check-input" id="inputTreats1" type="radio" name="okay_to_give_treats" value="1" {{$pet->okay_to_give_treats == 1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inputTreats1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-solid">
                                        <input class="form-check-input" id="inputTreats0" type="radio" name="okay_to_give_treats" value="0" {{$pet->okay_to_give_treats == 0? 'checked' : ''}}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex flex-col mt-2">
                                    <div class="form-check form-check-solid me-4">
                                        <input class="form-check-input" id="inputPhotosOnline1" type="radio" name="okay_to_use_photos_online" value="1" {{$pet->okay_to_use_photos_online == 1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inputPhotosOnline1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-solid">
                                        <input class="form-check-input" id="inputPhotosOnline0" type="radio" name="okay_to_use_photos_online" value="0" {{$pet->okay_to_use_photos_online == 0 ? 'checked' : ''}}>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="pet_food" id="inputPetFood" class="form-control" cols="30" rows="8" placeholder="e.g., Chicken-flavored kibble, Grain-free wet food">{{$pet->pet_food}}</textarea>
                                {{--                                <input type="text" name="pet_food" id="inputPetFood" class="form-control" placeholder="Enter pet's food here.." value="">--}}
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputFoodAllergies">Any Allergies?</label>
                                <textarea name="food_allergies" id="inputFoodAllergies" class="form-control" cols="30" rows="8" placeholder="Enter pet's food allergies here..">{{$pet->food_allergies}}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputHistoryofAggression">Any history of agression against any other dogs?</label>
                                <textarea name="history_of_aggression" id="inputHistoryofAggression" class="form-control" cols="30" rows="8" placeholder="Enter pet's history of agression here..">{{$pet->history_of_aggression}}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputCondition">Prone to any seizure, illness, ect.? If so please list:</label>
                                <textarea name="pet_condition" id="inputCondition" class="form-control" cols="30" rows="8" placeholder="Enter any illnesses or conditions here...">{{$pet->pet_condition}}</textarea>
                            </div>
                        </div>
