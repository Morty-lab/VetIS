...
<div class="modal fade" id="veterinarianListModal" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row d-flex justify-content-between">
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-4" placeholder="Enter Pet ID, Pet Name, Pet Owner, Pet Type">
                    </div>
                    <div class="col-md-2  d-flex justify-content-end">
                        <button class="btn btn-primary mb-4 d-flex justify-content-center align-items-center">
                            <i class="fa-solid fa-plus"></i> <span class="ms-2">New</span>
...
<div class="modal fade" id="servicePlanEditModal" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="dropdown mt-3 mb-2">
                    ...
                    <button class="form-select d-flex justify-between" id="serviceStatusMenuButton" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Status</button>
...
<div class="modal fade" id="serviceDeleteConfirmationModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle"><i class="fa-solid fa-trash me-2"></i>Delete Service</h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer"><button class="btn btn-primary" type="button"
                    data-bs-dismiss="modal">Cancel</button><a href=""
        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4 shadow-none">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-dark dropdown-toggle" id="printMenuButton" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Print Record</button>
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class=" col-12">
                                            <div class="dropdown">
                                                ...
                                                <button class="form-select d-flex justify-between" id="dropdownMenuButton" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Status</button>
                                                <div class="select-dropdown-menu dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="select-dropdown-item dropdown-item" href="#" data-selected="true" data-value="1">Filed</a>
                                                    <a class="select-dropdown-item dropdown-item" href="#" data-value="2">Ongoing</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu select-dropdown-menu" aria-labelledby="soapType">
                                                    ...
                                                    <a class="dropdown-item select-dropdown-item" href="#" data-value="3">Vaccination</a>
                                                    <a class="dropdown-item select-dropdown-item" href="#" data-value="4">Surgery</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
...
Category:</textarea></div>
                ...
                <div class="card-footer">
                    <button class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> <span class="ms-2">Save Record</span></button>
