...
@section('content')
    ...
    <div class="modal fade" id="archiveMedicalRecordModal" tabindex="-1" aria-labelledby="archiveMedicalRecordModal"
        aria-hidden="true">
    ...
    <!-- Services Modal -->
    <div class="modal fade" id="serviceListModal" tabindex="-1" role="dialog"
        aria-labelledby="myExtraLargeModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="card shadow-none pt-2 pb-2 px-3 rounded-3">
                        ...
                        <form action="{{ route('plan.store', ['recordID' => $record->id]) }}" method="post"
                            id="serviceForm">
                            @csrf
                        </form>
                    </div>
    ...
    <div class="container-xl px-4 mt-4">
        <nav class="nav nav-borders">
            <a class="nav-link ms-0" href="javascript:window.history.back();"><span class="px-2"><i
                ...
                <div class="row gy-2">
                    <div class="col-md-8">
                            ...
                            <div class="card-body">
                                <div class="row gy-2">
                                    ...
                                    <div class="col-md-3">
                                        Birthdate
                                        <p class="">
                                            {{ \Carbon\Carbon::parse($pet->pet_birthdate)->format('F d, Y') }}</p>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p>{{ $pet->anti_rabies_vaccination_date ? \Carbon\Carbon::parse($pet->anti_rabies_vaccination_date)->format('F j, Y') : 'No Record' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4 shadow-none">
                            ...
                            <div class="card-body">
                                <nav class="nav nav-borders">
                                    <a class="nav-link nav-tab active {{ request()->is('general') ? 'active' : '' }}"
                                        href="#general">Chief Complaint</a>
                                    <a class="nav-link nav-tab{{ request()->is('examination') ? 'active' : '' }}"
                                        href="#examination">Examination</a>
                                    <a class="nav-link nav-tab{{ request()->is('diagnosis') ? 'active' : '' }}"
                                        href="#diagnosis">Diagnosis</a>
                                    <a class="nav-link nav-tab{{ request()->is('treatment') ? 'active' : '' }}"
                                        href="#treatment">Treatment</a>
                                    <a class="nav-link nav-tab{{ request()->is('remarks') ? 'active' : '' }}"
                                        href="#remarks">Remarks</a>
                                    <a class="nav-link nav-tab{{ request()->is('prescription') ? 'active' : '' }}"
                                        href="#prescription">Prescription</a>
                                </nav>
                                <hr class="mt-0 mb-4" />
                                            ...
                                            <div class="card-body">
                                                <div class="row gy-5 mb-5">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $examination->respiration_rate ?? '' }}">
                                                            <span class="input-group-text">bpm</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                autocorrect="off" autocapitalize="off"
                                                                onkeypress="return (event.charCode == 46 || event.charCode >= 48 && event.charCode <= 57)"
                                                                name="weight" value="{{ $examination->weight ?? '' }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                autocorrect="off" autocapitalize="off"
                                                                onkeypress="return (event.charCode == 46 || event.charCode >= 48 && event.charCode <= 57)"
                                                                name="length" value="{{ $examination->length ?? '' }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                autocorrect="off" autocapitalize="off"
                                                                onkeypress="return (event.charCode == 46 || event.charCode >= 48 && event.charCode <= 57)"
                                                                name="height" value="{{ $examination->height ?? '' }}">
                                                            <span class="input-group-text">cm</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="body_condition[underweight]" id="underweight"
                                                                @if (isset($examination->body_condition) &&
                                                                        array_key_exists('underweight', json_decode($examination->body_condition, true)) &&
                                                                        json_decode($examination->body_condition, true)['underweight'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="underweight">Underweight</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="body_condition[normal]" id="normal"
                                                                @if (isset($examination->body_condition) &&
                                                                        array_key_exists('normal', json_decode($examination->body_condition, true)) &&
                                                                        json_decode($examination->body_condition, true)['normal'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="normal">Normal</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="body_condition[overweight]" id="overweight"
                                                                @if (isset($examination->body_condition) &&
                                                                        array_key_exists('overweight', json_decode($examination->body_condition, true)) &&
                                                                        json_decode($examination->body_condition, true)['overweight'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="overweight">Overweight</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="general_appearance[active]" id="active"
                                                                @if (isset($examination->general_appearance) &&
                                                                        array_key_exists('active', json_decode($examination->general_appearance, true)) &&
                                                                        json_decode($examination->general_appearance, true)['active'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="active">Active</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="general_appearance[lethargic]" id="lethargic"
                                                                @if (isset($examination->general_appearance) &&
                                                                        array_key_exists('lethargic', json_decode($examination->general_appearance, true)) &&
                                                                        json_decode($examination->general_appearance, true)['lethargic'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="lethargic">Lethargic</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="general_appearance[unresponsive]" id="unresponsive"
                                                                @if (isset($examination->general_appearance) &&
                                                                        array_key_exists('unresponsive', json_decode($examination->general_appearance, true)) &&
                                                                        json_decode($examination->general_appearance, true)['unresponsive'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="unresponsive">Unresponsive</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="general_appearance[aggresive]" id="aggressive"
                                                                @if (isset($examination->general_appearance) &&
                                                                        array_key_exists('aggresive', json_decode($examination->general_appearance, true)) &&
                                                                        json_decode($examination->general_appearance, true)['aggresive'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="unresponsive">Aggressive</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="skin_coat_condition[healthy]" id="healthySkin"
                                                                @if (isset($examination->skin_coat_condition) &&
                                                                        array_key_exists('healthy', json_decode($examination->skin_coat_condition, true)) &&
                                                                        json_decode($examination->skin_coat_condition, true)['healthy'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="healthySkin">Healthy</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="skin_coat_condition[dry]" id="dry"
                                                                @if (isset($examination->skin_coat_condition) &&
                                                                        array_key_exists('dry', json_decode($examination->skin_coat_condition, true)) &&
                                                                        json_decode($examination->skin_coat_condition, true)['dry'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="dry">Dry</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="skin_coat_condition[flaky]" id="flaky"
                                                                @if (isset($examination->skin_coat_condition) &&
                                                                        array_key_exists('flaky', json_decode($examination->skin_coat_condition, true)) &&
                                                                        json_decode($examination->skin_coat_condition, true)['flaky'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="flaky">Flaky</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="skin_coat_condition[hairLoss]" id="hairLoss"
                                                                @if (isset($examination->skin_coat_condition) &&
                                                                        array_key_exists('hairLoss', json_decode($examination->skin_coat_condition, true)) &&
                                                                        json_decode($examination->skin_coat_condition, true)['hairLoss'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="hairLoss">Hair
                                                                Loss</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="skin_coat_condition[parasites]" id="parasites"
                                                                @if (isset($examination->skin_coat_condition) &&
                                                                        array_key_exists('parasites', json_decode($examination->skin_coat_condition, true)) &&
                                                                        json_decode($examination->skin_coat_condition, true)['parasites'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="parasites">Parasites
                                                                Present</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="eyes_ears_nose_throat[clear]" id="clear"
                                                                @if (isset($examination->eyes_ears_nose_throat) &&
                                                                        array_key_exists('clear', json_decode($examination->eyes_ears_nose_throat, true)) &&
                                                                        json_decode($examination->eyes_ears_nose_throat, true)['clear'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="clear">Clear</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="eyes_ears_nose_throat[discharge]" id="discharge"
                                                                @if (isset($examination->eyes_ears_nose_throat) &&
                                                                        array_key_exists('discharge', json_decode($examination->eyes_ears_nose_throat, true)) &&
                                                                        json_decode($examination->eyes_ears_nose_throat, true)['discharge'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="discharge">Discharge</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="eyes_ears_nose_throat[redness]" id="redness"
                                                                @if (isset($examination->eyes_ears_nose_throat) &&
                                                                        array_key_exists('redness', json_decode($examination->eyes_ears_nose_throat, true)) &&
                                                                        json_decode($examination->eyes_ears_nose_throat, true)['redness'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="redness">Redness</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="eyes_ears_nose_throat[swelling]" id="swelling"
                                                                @if (isset($examination->eyes_ears_nose_throat) &&
                                                                        array_key_exists('swelling', json_decode($examination->eyes_ears_nose_throat, true)) &&
                                                                        json_decode($examination->eyes_ears_nose_throat, true)['swelling'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="swelling">Swelling</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="mouth_teeth[healthy]" id="healthyMouth"
                                                                @if (isset($examination->mouth_teeth) &&
                                                                        array_key_exists('healthy', json_decode($examination->mouth_teeth, true)) &&
                                                                        json_decode($examination->mouth_teeth, true)['healthy'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="healthyMouth">Healthy</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="mouth_teeth[tartar]" id="tartar"
                                                                @if (isset($examination->mouth_teeth) &&
                                                                        array_key_exists('tartar', json_decode($examination->mouth_teeth, true)) &&
                                                                        json_decode($examination->mouth_teeth, true)['tartar'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="tartar">Tartar</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="mouth_teeth[gingivitis]" id="gingivitis"
                                                                @if (isset($examination->mouth_teeth) &&
                                                                        array_key_exists('gingivitis', json_decode($examination->mouth_teeth, true)) &&
                                                                        json_decode($examination->mouth_teeth, true)['gingivitis'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="gingivitis">Gingivitis</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="mouth_teeth[missingTeeth]" id="missingTeeth"
                                                                @if (isset($examination->mouth_teeth) &&
                                                                        array_key_exists('missingTeeth', json_decode($examination->mouth_teeth, true)) &&
                                                                        json_decode($examination->mouth_teeth, true)['missingTeeth'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="missingTeeth">Missing
                                                                Teeth</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="lymph_nodes[normal]" id="normalNodes"
                                                                @if (isset($examination->lymph_nodes) &&
                                                                        array_key_exists('normal', json_decode($examination->lymph_nodes, true)) &&
                                                                        json_decode($examination->lymph_nodes, true)['normal'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="normalNodes">Normal</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="lymph_nodes[swollen]" id="swollenNodes"
                                                                @if (isset($examination->lymph_nodes) &&
                                                                        array_key_exists('swollen', json_decode($examination->lymph_nodes, true)) &&
                                                                        json_decode($examination->lymph_nodes, true)['swollen'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="swollenNodes">Swollen</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="lymph_nodes[enlarged]" id="enlargedNodes"
                                                                @if (isset($examination->lymph_nodes) &&
                                                                        array_key_exists('enlarged', json_decode($examination->lymph_nodes, true)) &&
                                                                        json_decode($examination->lymph_nodes, true)['enlarged'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="enlargedNodes">Enlarged</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="cardiovascular_system[normal]" id="normalHeart"
                                                                @if (isset($examination->cardiovascular_system) &&
                                                                        array_key_exists('normal', json_decode($examination->cardiovascular_system, true)) &&
                                                                        json_decode($examination->cardiovascular_system, true)['normal'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="normalHeart">Normal</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="cardiovascular_system[murmurs]" id="murmurs"
                                                                @if (isset($examination->cardiovascular_system) &&
                                                                        array_key_exists('murmurs', json_decode($examination->cardiovascular_system, true)) &&
                                                                        json_decode($examination->cardiovascular_system, true)['murmurs'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="murmurs">Murmurs</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="cardiovascular_system[irregularBeat]"
                                                                id="irregularBeat"
                                                                @if (isset($examination->cardiovascular_system) &&
                                                                        array_key_exists('irregularBeat', json_decode($examination->cardiovascular_system, true)) &&
                                                                        json_decode($examination->cardiovascular_system, true)['irregularBeat'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="irregularBeat">Irregular
                                                                Heartbeat</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="respiratory_system[normal]" id="normalResp"
                                                                @if (isset($examination->respiratory_system) &&
                                                                        array_key_exists('normal', json_decode($examination->respiratory_system, true)) &&
                                                                        json_decode($examination->respiratory_system, true)['normal'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="normalResp">Normal</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="respiratory_system[wheezing]" id="wheezing"
                                                                @if (isset($examination->respiratory_system) &&
                                                                        array_key_exists('wheezing', json_decode($examination->respiratory_system, true)) &&
                                                                        json_decode($examination->respiratory_system, true)['wheezing'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="wheezing">Wheezing</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="respiratory_system[coughing]" id="coughing"
                                                                @if (isset($examination->respiratory_system) &&
                                                                        array_key_exists('coughing', json_decode($examination->respiratory_system, true)) &&
                                                                        json_decode($examination->respiratory_system, true)['coughing'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="coughing">Coughing</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="respiratory_system[laboredBreathing]"
                                                                id="laboredBreathing"
                                                                @if (isset($examination->respiratory_system) &&
                                                                        array_key_exists('laboredBreathing', json_decode($examination->respiratory_system, true)) &&
                                                                        json_decode($examination->respiratory_system, true)['laboredBreathing'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="laboredBreathing">Labored
                                                                Breathing</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="digestive_system[normal]" id="normalDigestive"
                                                                @if (isset($examination->digestive_system) &&
                                                                        array_key_exists('normal', json_decode($examination->digestive_system, true)) &&
                                                                        json_decode($examination->digestive_system, true)['normal'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="normalDigestive">Normal</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="digestive_system[bloating]" id="bloating"
                                                                @if (isset($examination->digestive_system) &&
                                                                        array_key_exists('bloating', json_decode($examination->digestive_system, true)) &&
                                                                        json_decode($examination->digestive_system, true)['bloating'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="bloating">Bloating</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="digestive_system[vomiting]" id="vomiting"
                                                                @if (isset($examination->digestive_system) &&
                                                                        array_key_exists('vomiting', json_decode($examination->digestive_system, true)) &&
                                                                        json_decode($examination->digestive_system, true)['vomiting'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="vomiting">Vomiting</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="digestive_system[diarrhea]" id="diarrhea"
                                                                @if (isset($examination->digestive_system) &&
                                                                        array_key_exists('diarrhea', json_decode($examination->digestive_system, true)) &&
                                                                        json_decode($examination->digestive_system, true)['diarrhea'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="diarrhea">Diarrhea</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="musculoskeletal_system[normal]" id="normalMusculo"
                                                                @if (isset($examination->musculoskeletal_system) &&
                                                                        array_key_exists('normal', json_decode($examination->musculoskeletal_system, true)) &&
                                                                        json_decode($examination->musculoskeletal_system, true)['normal'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="normalMusculo">Normal</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="musculoskeletal_system[limping]" id="limping"
                                                                @if (isset($examination->musculoskeletal_system) &&
                                                                        array_key_exists('limping', json_decode($examination->musculoskeletal_system, true)) &&
                                                                        json_decode($examination->musculoskeletal_system, true)['limping'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="limping">Limping</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="musculoskeletal_system[jointPain]" id="jointPain"
                                                                @if (isset($examination->musculoskeletal_system) &&
                                                                        array_key_exists('jointPain', json_decode($examination->musculoskeletal_system, true)) &&
                                                                        json_decode($examination->musculoskeletal_system, true)['jointPain'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="jointPain">Joint
                                                                Pain</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="musculoskeletal_system[muscleAtrophy]"
                                                                id="muscleAtrophy"
                                                                @if (isset($examination->musculoskeletal_system) &&
                                                                        array_key_exists('muscleAtrophy', json_decode($examination->musculoskeletal_system, true)) &&
                                                                        json_decode($examination->musculoskeletal_system, true)['muscleAtrophy'] == 'on') checked @endif>
                                                            <label class="form-check-label" for="muscleAtrophy">Muscle
                                                                Atrophy</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="neurological_system[normal]" id="normalNeuro"
                                                                @if (isset($examination->neurological_system) &&
                                                                        array_key_exists('normal', json_decode($examination->neurological_system, true)) &&
                                                                        json_decode($examination->neurological_system, true)['normal'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="normalNeuro">Normal</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="neurological_system[seizures]" id="seizures"
                                                                @if (isset($examination->neurological_system) &&
                                                                        array_key_exists('seizures', json_decode($examination->neurological_system, true)) &&
                                                                        json_decode($examination->neurological_system, true)['seizures'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="seizures">Seizures</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="neurological_system[weakness]" id="weakness"
                                                                @if (isset($examination->neurological_system) &&
                                                                        array_key_exists('weakness', json_decode($examination->neurological_system, true)) &&
                                                                        json_decode($examination->neurological_system, true)['weakness'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="weakness">Weakness</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="neurological_system[uncoordinatedMovements]"
                                                                id="uncoordinated"
                                                                @if (isset($examination->neurological_system) &&
                                                                        array_key_exists('uncoordinatedMovements', json_decode($examination->neurological_system, true)) &&
                                                                        json_decode($examination->neurological_system, true)['uncoordinatedMovements'] == 'on') checked @endif>
                                                            <label class="form-check-label"
                                                                for="uncoordinated">Uncoordinated Movements</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="row mb-2 gy-2 medication-entry gx-2">
                                                                    ...
                                                                    <select class="form-control med-name select-med"
                                                                        ...
                                                                        @foreach ($medications as $medication)
                                                                            <option value="{{ $medication->id }}"
                                                                                {{ $treatment->productID == $medication->id ? 'selected' : '' }}>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <select class="form-control form-select med-type"
                                                                        name="medications[{{ $index }}][medication_type]">
                                                                        <option value=""></option>
                                                                        <option
                                                                            {{ $treatment->medication_type == 'Oral' ? 'selected' : '' }}>
                                                                            Oral</option>
                                                                        <option
                                                                            {{ $treatment->medication_type == 'IV (Intravenous)' ? 'selected' : '' }}>
                                                                            IV (Intravenous)</option>
                                                                        <option
                                                                            {{ $treatment->medication_type == 'IM (Intramuscular)' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card shadow-none">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <textarea rows="3" class="mb-3 d-none" name="remarks" id="clientCommunicationTextArea">
                                                {!! $record->remarks !!}
                                            </textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="dropdown no-caret">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end animated--fade-in-up"
                                                aria-labelledby="areaChartDropdownExample" style="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p class="text-primary">
                                                    {{ \Carbon\Carbon::parse($record->record_date)->format('F d, Y h:i A') }}
                                                </p>
                                            </div>
                                            <div class="col-md-6">
                                                Status
                                    ...
                                    <div class="card-footer">
                                        <div class="dropdown">
                                            ...
                                            <button class="btn btn-primary" type="submit">
                                                <i class="fa-solid fa-floppy-disk"></i> <span class="ms-2">Save
                                                    Record</span>
                                            </button>
            ...
            menu.querySelectorAll('.select-dropdown-item').forEach(item => {
                item.addEventListener('click', function(event) {
                    ...
                    if (button) {
                        ...
                        menu.querySelectorAll('.select-dropdown-item').forEach(i => i.setAttribute(
                            'data-selected', 'false'));
    ...
    <script>
            ...
            $(document).on('click', '.add-med', function(event) {
                ...
                `);
                    ...
                    if ($('.prescriptions').find('.text-danger').length === 0) {
                        let error = $(
                            '<div class="text-danger mt-2">Please fill in all fields before adding another prescription.</div>'
                        );
        ...
        $(document).ready(function() {
            $('.add-med').click(function() {
                let medicationIndex = $('#medications').children().length;
                ...
                if (name !== "" && dosage !== "" && type !== "") {
                    ...
                    $('#medications').find('.text-danger')
                        .remove(); // Remove error message when new row is added
                } else {
                    if ($('#medications').find('.text-danger').length === 0) {
                        let errorMsg = $(
                            '<div class="text-danger mt-3">Please fill in all fields before adding a new entry.</div>'
                        );
                ...
                if (procName !== "") {
                    ...
                    if (procName === "") {
                        if ($('#procedures .text-danger').length === 0) {
                            let errorMsg = $(
                                '<div class="text-danger mt-3">Please fill in the procedure name before adding a new entry.</div>'
                            );
                        ...
                        $('#procedures .text-danger')
                            .remove(); // Remove error if the procedure name is filled
                    }
                }
            });
