...
<script>
    ...
    if (receiptData) {
        ...
        document.getElementById("customer").textContent = receiptData.customer_id === 0 ? "Walk-In" : "Customer #" + receiptData.customer_id;
        document.getElementById("receiptNo").textContent = receiptData.receipt_no ? '#' + receiptData.receipt_no : '#000000';
