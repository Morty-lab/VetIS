...
<body class="nav-fixed">
    ...
    <!-- Modals -->
    <!-- Quantity Modal -->
    <div class="modal fade" id="enterQty" tabindex="-1" role="dialog" aria-labelledby="enterQty" aria-hidden="true" data-bs-backdrop="static">
                    ...
                    <div class="item-description ps-2">
                        <div class="row">
                            ...
                            <div class="col">
                                SKU: 132143r34
                                <br>
                                Price: <span class="text-primary">500</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <a href="google.com">
                                    ...
                                    <tr data-bs-toggle="modal" data-bs-target="#enterQty" style="cursor: pointer;">
                                        <td>132143r34</td>
                                        <td>Cat Food</td>
                                        <td>Food</td>
                                        <td>5</td>
    ...
    <div class="modal fade" id="customerModal" tabindex="-1" role="dialog" aria-labelledby="customerModal" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Discount Modal -->
    <div class="modal fade" id="discountModal" tabindex="-1" role="dialog" aria-labelledby="discountModal" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="voidTransactionModal" tabindex="-1" role="dialog" aria-labelledby="voidTransactionModal" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer"><button class="btn btn-primary" type="button" data-bs-dismiss="modal">Cancel</button><button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#voidTransactionCodeModal">Void Transaction</button></div>
            </div>
        </div>
    </div>

    <!-- Void Code Modal -->
    <div class="modal fade" id="voidTransactionCodeModal" tabindex="-1" role="dialog" aria-labelledby="voidTransactionCodeModal" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer"><button class="btn btn-danger" type="button">Void Transaction</button></div>
            </div>
        </div>
    </div>

    <!-- Payment Modal -->
    <div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="paymentModal" aria-hidden="true" data-bs-backdrop="static">
                                ...
                                <div class="receipt-section">
                                    <div class="receipt-display mt-3 bg-light p-4">
                                        ...
                                        <div class="total-section d-flex justify-content-between align-items-center">
                                            ...
                                            <p class="text-xl text-blue mb-0">950</p>
                                        </div>
                                    </div>
    ...
    <nav class="topnav navbar navbar-expand border-bottom justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <div class="main">
        <div class="row min-vh-100 g-0">
                ...
                <div class="col-12 px-4 pt-6 d-flex flex-column h-100 justify-content-between" id="sticky-sidebar">
                    ...
                    <div class="col-12">
                        <div class="proceed-payment">
                            <a href="#" class="btn btn-primary w-100 mb-2" data-bs-toggle="modal" data-bs-target="#paymentModal">Proceed Payment</a>
                        </div>
                        <!-- Only shows when transaction is completed -->
                        <div class="new-transaction">
                            <a href="#" class="btn btn-outline-primary w-100 mb-4">New Transaction</a>
                        </div>
                        <!-- -- -->
                    </div>
                </div>
            ...
            <div class="col-9 position-relative">
                <div class="px-4 py-4 d-flex justify-content-between bg-white border-bottom" style="padding-top: 5rem !important;">
                    <a href="" class="form-control ms-1" style="width: 300px !important; text-decoration: none;" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalXl">
                        <i class="fas fa-search me-2"></i>
                        Enter Product</a>
                    <div class="dropdown">
                        <button class="btn btn-outline-dark me-1 dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Options</button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#customerModal" class="dropdown-item">Customer</a></li>
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#discountModal" class="dropdown-item">Discount</a></li>
                            <hr class="my-2">
                            <li><a href="#" class="dropdown-item text-primary">Services Billing</a></li>
                            <hr class="my-2">
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#voidTransactionModal" class="dropdown-item text-danger">Void Transaction</a></li>
                        </ul>
                    </div>
                </div>
