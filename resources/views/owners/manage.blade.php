...
<div class="container-xl px-4 mt-4">
    <div class="card shadow-none">
        <div class="card-header d-flex d-flex justify-content-between align-items-center"><span>Pet Owners List</span>
            <a class="btn btn-primary justify-end" href="/addowner"><i class="fa-solid fa-plus me-2"></i>Add Pet Owner</a>
        </div>
        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                ...
                                $badgeClass = $petCount === 0 ? 'bg-light text-body' : 'bg-primary-soft text-primary';
                                $badgeText = $petCount === 0 ? '0 Pet Owned' : ($petCount === 1 ? '1 Pet Owned' : $petCount . ' Pets Owned');
                            @endphp
...
{{--                        </td>--}}
                        <td>
                            <a class="btn btn-datatable btn-primary px-5 py-3" href="{{route('owners.show',  $client->id)}}">View</a>
                        </td>
                    </tr>
                    @endforeach
