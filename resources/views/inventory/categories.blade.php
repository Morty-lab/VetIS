...
@section('content')
    ...
    @foreach ($categories as $item)
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        @if ($item->category_name != 'Medications' && $item->category_name != 'Vaccines')
                            ...
                            <button class="btn btn-danger" data-bs-toggle="modal"
                                ...
                                Category</button>
                        @else
                            <p class="text-danger">This category cannot be deleted as it is a system requirement.</p>
                        @endif
                    </div>
        ...
        @if ($item->category_name != 'Medications' && $item->category_name != 'Vaccinations')
            <!-- Edit Category Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer"><button class="btn btn-primary-soft text-primary" type="button"
                                ...
                                href="{{ route('categories.delete', $item->id) }}" class="btn btn-danger">Delete
                            </a></div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-datatable btn-icon btn-transparent-dark me-2"
                                        data-bs-toggle="modal" data-bs-target="#viewCategoryModal{{ $i->id }}"><i
                                            data-feather="more-vertical"></i></button>
                                    <button class="btn btn-datatable btn-icon btn-transparent-dark" data-bs-toggle="modal"
