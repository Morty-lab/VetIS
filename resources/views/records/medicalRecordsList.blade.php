                ...
                <div class="row gy-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="subject" id=""
                               placeholder="Specify the purpose of this medical record" class="form-control
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="veterinarian" id="" class="form-select attending-vet-med-rec
                        @error('veterinarian') is-invalid @enderror" data-placeholder="Select Attending Veterinarian"
