                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="inputOwnerName" type="select" placeholder="Name"
                                    ...
                                    <option value="1" selected>
                                        {{ Clients::where('id', $appointment->owner_ID)->first()->client_name }}</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="inputPetName" type="select" placeholder="Name"
                                    ...
                                    <option value="" selected>
                                        {{ \App\Models\Pets::where('id', $appointment->pet_ID)->first()->pet_name }}</option>

                                    <option value="" class="pets" style="display:none">Pet info</option>
                ...
                <div class="card shadow-none mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-datatable btn-primary px-5 py-3 m-0"
                            href="{{ route('owners.show', $appointment->owner_ID) }}"><i
                            ...
                            <div class="card-body">
                                @if ($appointment->status != 1 && $appointment->status != 2)
                                    <div class="dropdown w-100 mb-2">
                                        <button class="btn btn-primary dropdown-toggle w-100" id="dropdownFadeIn"
                                            type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">Update Appointment
                                            Status</button>
                                        <div class="dropdown-menu animated--fade-in w-100"
                                            aria-labelledby="dropdownFadeIn">
                                            @if (is_null($appointment->status))
                                                <a class="dropdown-item"
                                                    href="{{ route('appointments.schedule', ['id' => $appointment->id]) }}"><i
                                                        class="fas fa-calendar-check text-secondary me-2"></i>Schedule
                                                    Request</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item"
                                                    href="{{ route('appointments.cancel', ['id' => $appointment->id]) }}"><i
                                                        class="fas fa-times text-danger me-2"></i>Cancel Request</a>
                                            @endif

                                            @if ($appointment->status === 0)
                                                <a class="dropdown-item"
                                                    href="{{ route('appointments.done', ['id' => $appointment->id]) }}"><i
                                                        class="fas fa-check text-success me-2"></i>Done Appointment</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item"
                                                    href="{{ route('appointments.cancel', ['id' => $appointment->id]) }}"><i
                                                        class="fas fa-times text-danger me-2"></i>Cancel Appointment</a>
                                            @endif
                                        </div>
                                    </div>
