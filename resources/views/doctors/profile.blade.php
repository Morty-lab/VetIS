                    ...
                    <form action="{{ route('doctor.update', $doctor->id) }}" method="POST">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputFirstName" type="text" name="firstname" placeholder="First Name" value="{{ $doctor->firstname }}" />
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="inputEmailAddress" type="email" name="email" placeholder="Email Address" value="{{ $doctor->email }}" />
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputAddress">Address (Street, Barangay, City/Municipality,
                                Province)</label>
                            <input class="form-control" id="inputAddress" type="text" name="address" placeholder="Address" value="{{ $doctor->address }}" />
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputPhone" type="tel" name="phone_number" placeholder="Phone Number" value="{{ $doctor->phone_number }}" />
                            </div>
                            <!-- Form Group (birthday)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputBirthday">Birthday</label>
                                <input class="form-control" id="inputBirthday" type="text" name="birthday" placeholder="MM/DD/YYYY" value="{{ $doctor->birthday }}" />
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputPosition">Position</label>
                            <input class="form-control" id="inputPosition" type="text" name="position" placeholder="Position" value="{{ $doctor->position }}" />
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputUsername">Username</label>
                            <input class="form-control" id="inputUsername" type="text" name="username" placeholder="Username" value="{{ $doctor->username }}" />
                        </div>
                        <!-- Save changes button-->
