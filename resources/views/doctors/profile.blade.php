...
<div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
        <a class="nav-link active ms-0" href="/profiledoctor">Profile</a>
        <a class="nav-link" href="/securitydoctor">Security</a>
        <a class="nav-link" href="/adminsettingsdoctor">Admin Settings</a>
    </nav>
    <hr class="mt-0 mb-4" />
    <div class="row">
        <div class="col-xl-8">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="inputEmailAddress" type="email" placeholder="Email Address" value="princeinventorevltn89@gmail.com" />
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputAddress">Address (Street, Barangay, City/Municipality, Province)</label>
                            <input class="form-control" id="inputAddress" type="text" placeholder="Address" value="Purok - 3, Batangan, Valencia City, Bukidnon" />
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputPhone" type="tel" placeholder="Phone Number" value="09942194953" />
                            </div>
                            <!-- Form Group (birthday)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputBirthday">Birthday</label>
                                <input class="form-control" id="inputBirthday" type="text" name="birthday" placeholder="MM/DD/YYYY" value="08/11/2002" />
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputPosition">Position</label>
                            <input class="form-control" id="inputPosition" type="text" placeholder="Position" value="Veterinary Doctor" />
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputUsername">Username</label>
                            <input class="form-control" id="inputUsername" type="text" placeholder="Username" value="revltn" />
                        </div>
                        <!-- Save changes button-->
