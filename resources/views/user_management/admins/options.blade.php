                    ...
                    <div class="modal-body">
                        <div class="row g-3 mb-3">
                            <div class=" col-md-6">
                                ...
                                <input type="text" class="form-control" name="editFirstName" id=""
                                    value="">
                            </div>
                            <div class=" col-md-6">
                                <label class="small mb-1" for="editLastName">Last Name</label>
                                <input type="text" class="form-control" name="editLastName" id=""
                                    value="">
                            </div>
                            <div class="col-md-12">
                                <label class="small mb-1" for="editBirthday">Birthday</label>
                                <input type="date" class="form-control" name="editBirthday" id="editBirthday"
                                    value="" max="{{ \Carbon\Carbon::now()->toDateString() }}">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="editEmailAddress" id=""
                                    value="">
                            </div>
                            <div class="col-md-6">
