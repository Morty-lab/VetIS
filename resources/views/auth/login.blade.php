...
<html
  ...
  <head>
    ...
    <meta
      ...
      <title>Login | {{ config('variables.systemSuffix') ? config('variables.systemSuffix') : 'SystemSuffix'}}</title></title>
          ...
          <div class="card p-2">
            ...
            <div class="app-brand justify-content-center mt-5">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-heading fw-bold">VetIS</span>
              </a>
            </div>
            <!-- /Logo -->

            <div class="card-body mt-2">
              <h4 class="mb-2">Welcome to VetIS! 👋</h4>
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3 d-flex justify-content-between">
                  ...
                  <a href="href="{{ route('password.request') }}" class="float-end mb-1">
